...
// Bubble menu for editor, showed when selecting text
export default function Bmenu({editor}: {editor: any}) {
    return (
        <BubbleMenu
            editor={editor}
            tippyOptions={{ duration: 100 }}
            className="flex bg-slate-600 text-white pt-1 pb-1 pl-4 pr-4 text-lg rounded-lg gap-3"
        >
            <button
                onClick={() =>
